...
//git textg
    ...
    @Override
    //this method gets called by the system when the app is launched.
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            InputStream inputStream = assetManager.open("words.txt"); //creating the word file, somewhere in left side folder.
